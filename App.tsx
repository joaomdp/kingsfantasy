    ...
    <div className="flex flex-col min-h-screen bg-[#050505] text-[#f0f0f0]">
      ...
      <footer className="py-20 border-t border-white/5 text-center bg-black/40">
        <div className="max-w-[1440px] mx-auto px-8">
          <div className="flex flex-wrap justify-center gap-12 mb-10 font-black text-gray-500 text-xs tracking-[0.3em] uppercase">
          ...
          <p className="text-[11px] text-gray-700 max-w-3xl mx-auto leading-loose font-medium">
            ...
            © 2025 KINGS LENDAS. LEAGUE OF LEGENDS E MARCAS ASSOCIADAS SÃO PROPRIEDADES DA RIOT GAMES, INC.
          </p>
        </div>
      </footer>
    </div>
