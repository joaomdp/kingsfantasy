...
const VerifiedSeal: React.FC<{ size?: string }> = ({ size = "text-[12px]" }) => (
  <div className={`relative flex items-center justify-center ${size} drop-shadow-[0_0_8px_rgba(188,19,254,0.6)]`}>
    <i className="fa-solid fa-certificate text-[#bc13fe]"></i>
            ...
            {options.map((opt) => (
              ...
              >
                <div className="w-4 flex items-center justify-center">
                  {selected === opt && <i className="fa-solid fa-check text-[#bc13fe] text-[9px]"></i>}
                </div>
                {opt}
              </button>
            ))}
...
const Ranking: React.FC = () => {
  ...
  const myLeagues: League[] = [
    ...
    { id: 'l2', name: "Kings Cup Pro", icon: "fa-trophy", color: "bg-[#bc13fe]/10 text-[#bc13fe]", isVerified: true, members: "12.5k" },
      ...
      <div className="max-w-[1200px] mx-auto space-y-10 animate-in fade-in duration-500 pb-20">
        ...
        <div className="relative h-[240px] md:h-[320px] rounded-[48px] overflow-hidden group shadow-[0_20px_60px_rgba(0,0,0,0.6)] border border-white/5">
          <div className="absolute inset-0 bg-[#080808]">
             ...
             <div className="absolute inset-0 opacity-10 pointer-events-none" style={{ backgroundImage: 'radial-gradient(circle at center, #bc13fe 0%, transparent 70%)' }}></div>
          </div>
          <div className="absolute inset-0 flex flex-col items-center justify-center z-20 space-y-6">
            <div className={`w-28 h-28 md:w-36 md:h-36 rounded-[2.5rem] ${selectedLeague.color} flex items-center justify-center shadow-[0_0_50px_rgba(188,19,254,0.15)] border border-white/10 group-hover:scale-110 transition-transform duration-1000 ease-out`}>
          ...
          <div className="lg:col-span-4 space-y-6">
            <div className="glass-card rounded-[32px] p-8 border border-white/5">
              <div className="flex justify-between items-start mb-6">
                ...
                <div className="flex items-center gap-2.5">
                  <button 
                    ...
                    className="w-10 h-10 flex items-center justify-center bg-white/5 border border-white/10 rounded-xl text-gray-400 hover:text-[#bc13fe] hover:border-[#bc13fe]/30 transition-all shadow-xl group/share"
              ...
              <div className="mt-8 pt-8 border-t border-white/5 space-y-6">
                 ...
                 <div className="flex items-center justify-between p-5 bg-white/[0.02] rounded-2xl border border-white/5 group hover:border-[#bc13fe]/30 transition-all cursor-pointer">
                    <div className="flex items-center gap-4">
                       <span className="font-orbitron font-black text-lg text-[#bc13fe] w-10">1458</span>
                       <div className="w-11 h-11 rounded-xl bg-black border border-white/10 flex items-center justify-center text-[#bc13fe] shadow-lg">
                         <i className="fa-solid fa-shield-halved text-sm"></i>
                       </div>
                       <div>
                          <p className="text-[13px] font-black text-white uppercase tracking-tight leading-none mb-1 group-hover:text-[#bc13fe] transition-colors">GOATEAM</p>
               ...
               <div className="space-y-5">
                  {[1, 2, 3, 4].map(rank => (
                    <div key={rank} className="flex items-center justify-between group cursor-pointer">
                       <div className="flex items-center gap-4">
                          <span className="w-6 text-[11px] font-orbitron font-black text-gray-700 group-hover:text-[#bc13fe]">{790 + rank}</span>
                          <div className="w-9 h-9 rounded-xl bg-white/5 border border-white/5 overflow-hidden group-hover:border-[#bc13fe]/40 transition-all">
                             <img src={`https://picsum.photos/seed/user${rank + 10}/100`} className="w-full h-full object-cover" alt="" />
                          </div>
                          <div>
                             <p className="text-[11px] font-black text-white uppercase tracking-tighter group-hover:text-[#bc13fe] transition-colors">PLAYER PRO {rank}</p>
            ...
            <div className="glass-card rounded-[32px] overflow-hidden border border-white/5 shadow-2xl">
              ...
              <div className="divide-y divide-white/[0.03]">
                 {MOCK_RANKING.map((entry, idx) => {
                   ...
                   return (
                     <div key={idx} className={`flex items-center p-6 px-10 gap-10 hover:bg-white/[0.02] transition-all group cursor-pointer ${isUser ? 'bg-[#bc13fe]/[0.03]' : ''}`}>
                        <div className="w-8 text-center shrink-0">
                           <span className={`font-orbitron font-black text-base ${idx < 3 ? 'text-[#bc13fe]' : 'text-gray-700'}`}>
                             {entry.rank}
                           </span>
                        </div>
                        
                        <div className="relative w-12 h-12 shrink-0">
                           <div className="absolute inset-0 bg-gradient-to-br from-[#bc13fe]/20 to-transparent rounded-xl border border-white/5 group-hover:rotate-6 transition-transform"></div>
                        ...
                        <div className="flex-1">
                           <h4 className="font-black text-white text-[15px] uppercase tracking-tighter group-hover:text-[#bc13fe] transition-colors leading-none mb-1.5">{entry.teamName}</h4>
    ...
    <div className="max-w-[1000px] mx-auto animate-in fade-in duration-700 space-y-8">
            ...
            >
              <div 
                ...
                style={{ 
                  ...
                  background: `conic-gradient(from ${scrollProgress * 2.0}deg, transparent 0%, rgba(188, 19, 254, 0.6) 15%, rgba(188, 19, 254, 0.8) 20%, transparent 40%)`,
                ...
                <div className="text-center mb-12 relative">
                  ...
                  {!isSubmitting && (
                    <button 
                      ...
                      className="absolute -top-6 -right-6 w-12 h-12 flex items-center justify-center text-gray-700 hover:text-[#bc13fe] transition-all duration-500 hover:rotate-90 z-[70]"
                    >
                ...
                <form onSubmit={handleCreateLeague} className="space-y-10">
                  <div className="space-y-4">
                    <label className="text-[10px] font-black text-gray-500 uppercase tracking-tighter block">
                      BRASÃO DA COMPETIÇÃO <span className="text-[#bc13fe] ml-1">*</span>
                    </label>
                    <div 
                      ...
                      className={`relative w-full aspect-[21/9] rounded-3xl border transition-all duration-500 flex flex-col items-center justify-center cursor-pointer overflow-hidden group 
                        ${leagueImage ? 'border-[#bc13fe]/50 bg-black' : 'border-white/5 bg-white/[0.01] hover:bg-white/[0.03] hover:border-[#bc13fe]/30'}
                  ...
                  <div className="space-y-4">
                    <label className="text-[10px] font-black text-gray-500 uppercase tracking-tighter block">
                      NOME DA LIGA <span className="text-[#bc13fe] ml-1">*</span>
                    </label>
                    <input 
                      type="text" 
                      ...
                      className="w-full bg-white/5 border border-white/10 rounded-2xl py-5 px-7 text-[13px] text-white font-black tracking-tighter focus:outline-none focus:border-[#bc13fe]/40 transition-all placeholder:text-gray-800"
                      required
                    />
                  </div>
                  ...
                  <div className="space-y-4">
                    <label className="text-[10px] font-black text-gray-500 uppercase tracking-tighter block">
                      SISTEMA DE PONTUAÇÃO <span className="text-[#bc13fe] ml-1">*</span>
                    </label>
                    <div className="grid grid-cols-1 gap-3">
                      <div 
                        onClick={() => !isSubmitting && setLeagueFormat('continuo')}
                        className={`cursor-pointer p-5 rounded-2xl border transition-all duration-500 flex items-start gap-4 ${leagueFormat === 'continuo' ? 'bg-[#bc13fe]/10 border-[#bc13fe]/40' : 'bg-white/[0.01] border-white/5 hover:border-white/10'}`}
                      >
                        <div className={`mt-0.5 w-5 h-5 rounded-full border-2 flex items-center justify-center shrink-0 transition-all ${leagueFormat === 'continuo' ? 'border-[#bc13fe]' : 'border-gray-800'}`}>
                          {leagueFormat === 'continuo' && <div className="w-2.5 h-2.5 rounded-full bg-[#bc13fe] shadow-[0_0_8px_rgba(188,19,254,0.6)]"></div>}
                        </div>
                        <div>
                          <p className={`text-[10px] font-black uppercase tracking-tighter mb-1 ${leagueFormat === 'continuo' ? 'text-[#bc13fe]' : 'text-gray-500'}`}>TEMPORADA REGULAR</p>
                      ...
                      <div 
                        ...
                        className={`cursor-pointer p-5 rounded-2xl border transition-all duration-500 flex items-start gap-4 ${leagueFormat === 'limitado' ? 'bg-[#bc13fe]/10 border-[#bc13fe]/40' : 'bg-white/[0.01] border-white/5 hover:border-white/10'}`}
                      >
                        <div className={`mt-0.5 w-5 h-5 rounded-full border-2 flex items-center justify-center shrink-0 transition-all ${leagueFormat === 'limitado' ? 'border-[#bc13fe]' : 'border-gray-800'}`}>
                          {leagueFormat === 'limitado' && <div className="w-2.5 h-2.5 rounded-full bg-[#bc13fe] shadow-[0_0_8px_rgba(188,19,254,0.6)]"></div>}
                        </div>
                        <div>
                          <p className={`text-[10px] font-black uppercase tracking-tighter mb-1 ${leagueFormat === 'limitado' ? 'text-[#bc13fe]' : 'text-gray-500'}`}>EVENTO DE TIRO CURTO</p>
                  ...
                  <div className="pt-8 flex flex-col items-center">
                    <button 
                      ...
                      className={`w-full py-4 rounded-2xl font-orbitron font-black text-sm tracking-[0.2em] uppercase transition-all duration-500 shadow-2xl relative overflow-hidden group/btn ${
                        submitStatus === 'success' ? 'bg-green-600 text-white' : 'bg-[#bc13fe] text-black hover:brightness-110 active:scale-[0.98]'
                      }`}
                    >
      ...
      <div className="flex flex-col sm:flex-row justify-between items-center gap-6">
        <div className="text-center sm:text-left">
          <h2 className="text-[10px] font-black text-[#bc13fe] uppercase tracking-wider mb-2 animate-in slide-in-from-left duration-700">MODO COMPETITIVO</h2>
          <h1 className="text-4xl md:text-5xl font-orbitron font-black text-white uppercase tracking-tighter leading-none animate-in slide-in-from-left duration-700 delay-100">
            MINHAS <span className="text-[#bc13fe]">LIGAS</span>
          </h1>
        </div>
        <button 
          onClick={handleOpenModal}
          className="group flex items-center gap-3 px-8 py-4 bg-white/5 border border-white/10 rounded-2xl text-[10px] font-black text-white uppercase tracking-[0.1em] hover:bg-[#bc13fe] hover:text-black transition-all duration-500 shadow-2xl hover:shadow-[#bc13fe]/30 relative z-10"
        >
      ...
      <div className="grid grid-cols-1 gap-4">
        {myLeagues.map((league, idx) => (
          <div 
            ...
            className="group glass-card hover-shine rounded-[28px] p-5 flex flex-col sm:flex-row items-center justify-between border border-white/5 hover:border-[#bc13fe]/50 hover:bg-white/[0.04] transition-all duration-500 cursor-pointer relative overflow-hidden animate-in slide-in-from-bottom-8"
            style={{ animationDelay: `${idx * 60}ms`, animationFillMode: 'backwards' }}
          >
            <div className="flex items-center gap-6 relative z-20">
              <div className={`w-14 h-14 rounded-2xl ${league.color} flex items-center justify-center shadow-2xl transition-all duration-700 border border-transparent group-hover:border-[#bc13fe]/30 group-hover:scale-110 group-hover:rotate-3`}>
                <i className={`fa-solid ${league.icon} text-xl`}></i>
              </div>
              <div className="text-center sm:text-left">
                <div className="flex items-center justify-center sm:justify-start gap-3 mb-1">
                  <h3 className="font-orbitron font-black text-xl text-white group-hover:text-[#bc13fe] transition-colors uppercase tracking-tighter">{league.name}</h3>
            ...
            <div className="flex items-center gap-10 mt-5 sm:mt-0 relative z-20 sm:border-l border-white/10 sm:pl-10">
               ...
               <div className="w-12 h-12 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center transition-all duration-500 group-hover:bg-white/10 group-hover:border-[#bc13fe]/60 group-hover:shadow-[0_0_20px_rgba(188,19,254,0.2)] relative z-20">
